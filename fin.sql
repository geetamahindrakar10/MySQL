...
CREATE TABLE `mytable` (
  `gender` VARCHAR(1024),
  `age` BIGINT,
  `Investment_Avenues` VARCHAR(1024),
  `Mutual_Funds` BIGINT,
  `Equity_Market` BIGINT,
  `Debentures` BIGINT,
  `Government_Bonds` BIGINT,
  `Fixed_Deposits` BIGINT,
  `PPF` BIGINT,
  `Gold` BIGINT,
  `Stock_Marktet` VARCHAR(1024),
  `Factor` VARCHAR(1024),
  `Objective` VARCHAR(1024),
  `Purpose` VARCHAR(1024),
  `Duration` VARCHAR(1024),
  `Invest_Monitor` VARCHAR(1024),
  `Expect` VARCHAR(1024),
  `Avenue` VARCHAR(1024),
  `What are your savings objectives?` VARCHAR(1024),
  `Reason_Equity` VARCHAR(1024),
  `Reason_Mutual` VARCHAR(1024),
  `Reason_Bonds` VARCHAR(1024),
  `Reason_FD` VARCHAR(1024),
  `Source` VARCHAR(1024)
);

INSERT INTO `mytable` (`gender`,`age`,`Investment_Avenues`,`Mutual_Funds`,`Equity_Market`,`Debentures`,`Government_Bonds`,`Fixed_Deposits`,`PPF`,`Gold`,`Stock_Marktet`,`Factor`,`Objective`,`Purpose`,`Duration`,`Invest_Monitor`,`Expect`,`Avenue`,`What are your savings objectives?`,`Reason_Equity`,`Reason_Mutual`,`Reason_Bonds`,`Reason_FD`,`Source`)
VALUES
